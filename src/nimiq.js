// source: https://cdn.nimiq.com/nimiq.js
...
require = (function() {
...
})()(
  {
    ...
    3: [
      ...
      {
        '../../modules/_core': 12,
        '../../modules/es6.object.define-property': 68
      }
    ],
    4: [
      function(e, t, r) {
      ...
      },
      {
        ...
        '../modules/es6.promise': 70,
        '../modules/es6.string.iterator': 71,
        '../modules/es7.promise.finally': 72,
        '../modules/es7.promise.try': 73,
        '../modules/web.dom.iterable': 74
      }
    ],
    5: [
      function(e, t, r) {
        ...
        (r = t.exports = function(e, t, r, l, _) {
          ...
          if (i(y)) {
            for (p = a(e.length); p > g; g++)
              if (
                (v = t ? m(c((d = e[g]))[0], d[1]) : m(e[g])) === u ||
                v === f
              )
                return v;
          } else
            for (h = y.call(e); !(d = h.next()).done; )
              if ((v = o(h, m, d.value, t)) === u || v === f) return v;
        }).BREAK = u;
        r.RETURN = f;
      },
      {
    ...
    32: [
      function(e, t, r) {
        ...
        t.exports = function(e, t, r, d, h, v, y) {
          s(r, t, d);
          var m,
            g,
            b,
          ...
          if (h) {
            ...
            if (y) for (g in m) g in N || i(N, g, m[g]);
            else o(o.P + o.F * (_ || k), t, m);
          }
          return m;
        };
      },
    ...
    53: [
      ...
      { './_core': 12, './_global': 21, './_library': 36 }
    ],
    54: [
      function(e, t, r) {
        var n = e('./_an-object'),
      ...
      { './_a-function': 5, './_an-object': 8, './_wks': 65 }
    ],
    55: [
      function(e, t, r) {
        var n = e('./_to-integer'),
    ...
    66: [
      ...
      { './_classof': 10, './_core': 12, './_iterators': 35, './_wks': 65 }
    ],
    67: [
      function(e, t, r) {
        'use strict';
      ...
      function(e, t, r) {
        ...
        if (!C) {
          ...
          (n = function Promise(e) {
            ...
            this._h = 0;
            this._n = !1;
          }).prototype = e('./_redefine-all')(E.prototype, {
            then: function then(e, t) {
              var r = O(v(this, E));
              r.ok = 'function' != typeof e || e;
              r.fail = 'function' == typeof t && t;
              r.domain = S ? k.domain : undefined;
              this._c.push(r);
        ...
        e('./_set-to-string-tag')(E, 'Promise');
